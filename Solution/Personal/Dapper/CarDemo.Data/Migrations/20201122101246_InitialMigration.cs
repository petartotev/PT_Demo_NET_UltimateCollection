        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Image = table.Column<string>(nullable: true),
                    ApiKey = table.Column<Guid>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(nullable: false),
                    IsOpenable = table.Column<bool>(nullable: false),
                    Color = table.Column<string>(nullable: true),
                    Price = table.Column<decimal>(nullable: false),
                    DateProduction = table.Column<DateTime>(nullable: false),
                    Image = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumberCylinders = table.Column<int>(nullable: false),
                    Price = table.Column<decimal>(nullable: false),
                    DateProduction = table.Column<DateTime>(nullable: false),
                    Image = table.Column<string>(nullable: true),
                    CarId = table.Column<Guid>(nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CarDrivers", x => new { x.CarId, x.DriverId });
                    table.ForeignKey(
